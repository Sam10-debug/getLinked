...
const Partners = () => {
  ...
  return (
    <section className=" flex flex-col items-center mt-16">
        ...
        <div data-aos="flip-right" data-aos-duration="1000" className=" border-buttonGradient2 border-2 rounded-lg w-[90%] lg:w-4/5 flex justify-center h-[148px] lg:h-[560px] items-center mt-12">
