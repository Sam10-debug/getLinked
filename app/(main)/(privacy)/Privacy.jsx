...
const Privacy=()=>{
    ...
    return(
        <section className=" flex px-8 flex-col lg:flex-row ">
            <div data-aos="flip-right" data-aos-duration="1000" className="flex-1 text-white ">
                <h2 className=" text-[24px] lg:text-[32px] font-bold ">Privacy Policy and</h2>
                <h2 className=" text-[24px] lg:text-[32px] font-bold text-buttonGradient2">Terms</h2>
                ...
                <div className='rounded-[5px] border-buttonGradient2 border-[1px] p-8 mt-12 '>
                    <p className=" text-sm leading-[216.4%] text-center lg:text-left">At getlinked tech Hackathon 1.0, we value your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your data when you participate in our tech hackathon event. By participating in our event, you consent to the practices described in this policy.</p>
            ...
            <div data-aos="fade-right" data-aos-duration="1000" className='flex-1 padlock flex justify-center'>
